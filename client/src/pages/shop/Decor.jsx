...
export default function Decor() {
  return (
    <div className="max-w-6xl mx-auto px-6 py-16">
      ...
      <h1 className="text-4xl font-bold mb-10">Décor</h1>

      <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6">
        {decorSubcategories.map((sub) => {
          const products = getDecorProducts(sub);
          const cover = products[0]?.image;

          return (
            <Link key={sub.slug} to={`/shop/decor/${sub.slug}`} className="group">
