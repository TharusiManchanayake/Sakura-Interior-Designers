...
export default function Plants() {
  return (
    <div className="max-w-6xl mx-auto px-6 py-16">
      ...
      <h1 className="text-4xl font-bold mb-10">Plants & Planters</h1>

      <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6">
        {plantsSubcategories.map((sub) => {
          const products = getPlantsProducts(sub);
          const cover = products[0]?.image;

          return (
            <Link key={sub.slug} to={`/shop/plants/${sub.slug}`} className="group">
